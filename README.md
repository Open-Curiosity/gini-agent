...
- [Remote Access](docs/remote-access.md): tunnel connectors — the managed Gini Relay plus manual Tailscale/ngrok/Cloudflare — selecting a mode and confirming it
