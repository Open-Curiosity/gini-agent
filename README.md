...
- [Remote Access](docs/remote-access.md): tunnel providers — Gini Relay, Tailscale, ngrok, Cloudflare, all drivable from the app — selecting a mode, confirming it, and manual fronts
