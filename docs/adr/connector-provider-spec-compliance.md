...
Two prior ADRs (connector-secret-storage.md and skills-and-connectors.md) established the model: separate credential plane (then called Identity), separate skill plane, activation by dependency. The work shipped. In use, three things became clear:
