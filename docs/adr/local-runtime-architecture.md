# ADR: Local Runtime Architecture
...
- Real connector secret storage (see ADR connector-secret-storage, ADR skills-and-connectors, and ADR connector-provider-spec-compliance).
