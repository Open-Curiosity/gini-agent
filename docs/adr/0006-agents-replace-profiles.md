# ADR 0006: Agents Replace Profiles And Drive Runtime Behavior

- **Status:** Accepted
- **Date:** 2026-05-13
- **See also:** [ADR 0007: Per-Agent Memory Isolation](./0007-agent-memory-isolation.md)
...
| `memoryNamespace` | Agent id. See ADR 0007. |
