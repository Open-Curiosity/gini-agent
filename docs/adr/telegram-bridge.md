...
- `bun test src/integrations/telegram-format.test.ts` covers the MarkdownV2 formatter: bold conversion, code-span preservation, and exhaustive special-character escaping.
