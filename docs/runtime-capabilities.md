...
| Skills | `gini skills list/add/show/search/validate/test/trust/disable/rollback`, `/api/skills` |
...
| Profiles/config | `gini profiles list/create/use`, instance-aware config |
