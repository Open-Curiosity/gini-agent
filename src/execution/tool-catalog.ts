      ...
      parameters: {
        ...
        properties: {
          action: {
            ...
            description: "What to do: 'add' a new watcher, 'list' existing watchers, or 'remove' a watcher by id."
          },
          ...
          id: { type: "string", description: "For action='remove': the watcher id to delete (from action='list')." }
        },
        required: ["action"]
      }
    }
