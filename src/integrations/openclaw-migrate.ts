...
//     a follow-up `gini embedding reembed --all-banks` pass populates
//     vectors across every per-agent bank using the configured
//     embedding provider. The legacy
...
export async function applyMigration(
  ...
  // `gini embedding reembed --all-banks` pass populates vectors
  // using the configured embedding provider across every
  // per-agent bank. We sanitize network/status
