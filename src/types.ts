...
export interface RuntimeConfig {
  ...
  // Intended for trusted, dev-mode use only. See ADR dangerously-auto-approve for the
  // full audit contract.
...
export interface ConnectorRecord {
  ...
  // in the registry). Renamed from `kind` in ADR connector-provider-spec-compliance.
  provider: string;
