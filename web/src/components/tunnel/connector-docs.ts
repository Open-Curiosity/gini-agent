// Per-connector guide URLs (docs/remote-access/<id>.md served by the gateway,
// rendered inline via DocSheet/DocReference). Each connector's guide is
...
export const CONNECTOR_DOC_URLS: Record<TunnelProviderId, string> = {
