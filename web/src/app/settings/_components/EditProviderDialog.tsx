    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="gap-5 border-border bg-card p-7 sm:max-w-md">
        ...
        >
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-base-url" className="text-[13px] font-semibold text-foreground">
              Base URL <span className="font-normal text-muted-foreground">(blank = default endpoint)</span>
            </Label>
            <Input
              id="edit-base-url"
              autoComplete="off"
          ...
          {row.name === "openai" && isAzure ? (
            <div className="space-y-3">
              <p className="text-[12px] font-semibold text-foreground">
                Azure OpenAI <span className="font-normal text-muted-foreground">— deployment settings for this endpoint</span>
              </p>
              <div className="space-y-2">
